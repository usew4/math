...
def _compute_trust_weights(sigma, availability=None):
    """
    ...
    if availability is not None:
        w_raw = w_raw * availability.to(w_raw.dtype)
...
def _imtd_classification(s_logits, t_a, t_t, t_v, tau, availability=None):
    ...
    w = _compute_trust_weights(sigma, availability)
...
def compute_imtd_loss(logits_c,
                      ...
                      umask, args, imtd_tau=1.0, availability=None):
    """
