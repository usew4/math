...
class ALMT(nn.Module):
    def __init__(self, args):
        ...
        self.regression_layer = nn.Sequential(
            nn.Linear(args.token_dim, getattr(args, 'output_dim', 1))
        )

    def forward_features(self, x_visual, x_audio, x_text):
        b = x_visual.size(0)
    ...
    def forward(self, x_visual, x_audio, x_text):
        return self.regression_layer(self.forward_features(x_visual, x_audio, x_text))
